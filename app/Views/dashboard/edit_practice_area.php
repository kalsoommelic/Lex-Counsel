...
<head>
    ...
    <title>Edit Practice Area - Lex Counsel</title>
...
<main class="main">
    ...
    <div class="topbar">
        <div>
            ...
            <p>Update the information of this legal practice area.</p>
        </div>
    ...
    <div class="form-card">
        ...
        <form
            action="<?= base_url('admin/practice-areas/edit/' . $practiceArea['id']) ?>"
            method="post"
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input
                        type="text"
                        name="name"
                        value="<?= esc(old('name', $practiceArea['name'])) ?>"
                        required
                    >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input
                        type="text"
                        name="icon"
                        value="<?= esc(old('icon', $practiceArea['icon'] ?? '')) ?>"
                ...
                <div class="form-group full-width">
                    ...
                    ><?= esc(old('short_description', $practiceArea['short_description'] ?? '')) ?></textarea>
                </div>
                ...
                <div class="form-group full-width">
                    ...
                    ><?= esc(old('description', $practiceArea['description'] ?? '')) ?></textarea>
                </div>


                <div class="form-group">
                    <label>Practice Area Image</label>
                ...
                <div class="form-group">
                    ...
                    <select name="status">
                        ...
                        <option
                            value="1"
                            <?= old('status', $practiceArea['status']) == '1' ? 'selected' : '' ?>
                        >
                            Active
                        </option>
                        ...
                        <option
                            value="0"
                            <?= old('status', $practiceArea['status']) == '0' ? 'selected' : '' ?>
                        >
                            Inactive
                        </option>
